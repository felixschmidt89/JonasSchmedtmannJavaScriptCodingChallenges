...
checkWinner(averageScoreDolphins1, averageScoreKoalas1);
checkWinner(averageScoreDolphins2, averageScoreKoalas2);

// Learning: Don't use const keyword when testing with multiple data. First use let and later reassign.
